...
public class BlockNode {
    ...
    public int hashCode() {
        ...
        int result = 1;
        result =
            prime * result + ((getContents().get(0) == null) ? 0 : getContents().get(0).hashCode());
        return result;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getContents().get(0) == null) {
            return other.getContents().get(0) == null;
        } else
            return getContents().get(0).equals(other.getContents().get(0));
    }
