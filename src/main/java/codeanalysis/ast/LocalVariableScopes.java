...
public class LocalVariableScopes {
    ...
    public LocalVariableScope findScope(String variableName, int appearedLineNum,
...
//			String typeName = packageName + "." + simpleName;
            ...
            if (typeName.equals(fullQualifiedTypeName) && scope.getVariableName()
                .equals(variableName) &&
                ...
                if (candScope == null) {
                    ...
                    if (candScope.getStartLine() <= scope.getStartLine()
                        && candScope.getEndLine() >= scope.getEndLine()) {
                        candScope = scope;
                    }
                }
            }
