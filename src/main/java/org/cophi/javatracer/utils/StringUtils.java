...
import org.cophi.javatracer.core.Constants;
...
public class StringUtils {
     ...
     *                           types from the outer-most to the direct parent of the type (for
     *                           example, if the class is x.y.A$B$C then the enclosing types are [A,
     *                           B]. This is an empty array if the type is a top-level type.
     */
