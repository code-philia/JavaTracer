...
public class VariableUtil {
    ...
    /**
     * For now, the virtual variable is never considered as equivalent (or, compatible). It means
     * that the path between method invocation is not jumped, which facilitates the abstraction
     * intention. That is, the jump occurs only in the same abstraction level.
     *
     * @param var1
     * @param var2
     * @return
    ...
    public static boolean isEquivalentVariable(Variable var1, Variable var2) {
        ...
        boolean isEquivalentVariable =
            simpleVarID1.equals(simpleVarID2) || var1.getName().equals(var2.getName());
