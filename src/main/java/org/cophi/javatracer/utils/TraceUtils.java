...
//	}
    ...
    public static String getFieldVarId(String parentVarId, String fieldName, String fieldType,
        Object fieldValue) {
        return Variable.concatenateFieldVarID(parentVarId, fieldName);
    }

    public static String getArrayElementVarId(String parentVarId, int index, String elementType,
        Object eleValue) {
        return Variable.concatenateArrayElementVarID(parentVarId, String.valueOf(index));
    }
