...
public class ByteCodeParser {
    ...
    public static JavaClass parse(String className, ProjectConfig projectConfig) {
        ...
        try {
            ...
            String jdkPath = projectConfig.getJavaHome() + File.separator + "jre" +
    ...
    public static void parse(String className, ByteCodeVisitor visitor,
