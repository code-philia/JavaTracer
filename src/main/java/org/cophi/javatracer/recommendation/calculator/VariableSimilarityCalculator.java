...
public class VariableSimilarityCalculator {
    ...
    private VariableSimilarity calculateArrayElementSimilarity(ArrayElementVar aVar1,
        VarValue aValue1,
...
//		return new VariableSimilarity(0, 0, 0, 0, 0, 0, isSameObject, isSameType, isSameName);
        return new VariableSimilarity(0, 0, isSameObject, isSameType, isSameType, isSameName, 0, 0,
            0);
    }

    private VariableSimilarity calculateFieldSimilarity(FieldVar fVar1, VarValue fValue1,
        FieldVar fVar2, VarValue fValue2) {
        int isSameObject = 0;
        ...
        return new VariableSimilarity(0, 0, isSameObject, isSameObjectType, isSameType, isSameName,
            0, 0, 0);
    }
