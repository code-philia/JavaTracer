...
import org.cophi.javatracer.model.BreakPointValue;
...
import org.cophi.javatracer.model.variable.ConditionVar;
...
public class TraceNode {
    ...
    private final transient Map<String, VarValue> readVariableMap = new HashMap<>();
    private final transient Map<String, VarValue> writtenVariableMap = new HashMap<>();
...
//	private Map<TraceNode, List<String>> dataDominatees = new HashMap<>();
    ...
    /**
     * this filed is used as a temporary field during the trace construction for returning value.
     */
    private List<VarValue> returnedVariables;

    /**
     * this filed is used as a temporary field during the trace construction for passing parameter
...
//	}
    ...
    public Collection<VarValue> getWrittenVariables() {
        if (this.writtenVariables == null
            || this.writtenVariables.size() < this.writtenVariableMap.size()) {
