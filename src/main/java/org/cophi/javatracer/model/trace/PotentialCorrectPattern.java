...
public class PotentialCorrectPattern {
    ...
    /**
     * The first path which forms this pattern. This path must have its start node and end node
     * label the correctness of their read/written variables.
     */
    ...
    /**
     * Predicate: the path should be a valid path (see
     * {@link #checkValidLabelInstance(PathInstance)} method)
     *
     * @param path
     */
