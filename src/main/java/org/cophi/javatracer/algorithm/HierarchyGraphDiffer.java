...
public class HierarchyGraphDiffer {
    ...
    /**
     * This diff result does not contain the difference of rootBefore and rootAfter themselves, only
     * the different of their children.
     * <p>
     * The isCompareRoot parameter is to indicate whether the algorithm need to consider the
     * difference of the root node.
     *
     * @param rootBefore
     * @param rootAfter
     * @param isCompareRoot
