...
import org.cophi.javatracer.instrumentation.StepMismatchChecker;
import org.cophi.javatracer.instrumentation.output.TraceOutputReader;
...
public class PrecheckInfo {
    ...
    public String toString() {
        return "PrecheckInfo [threadNum=" + threadNum + ", stepTcounted_stepTotalotal=" + stepTotal
