...
public class WildcardMatcher {
     ...
     * <p>
     * java.util.* : include all types and packages under java.util package java.util.*\ : include
     * all types only under java.util package java.util.Arrays : include type Arrays only
