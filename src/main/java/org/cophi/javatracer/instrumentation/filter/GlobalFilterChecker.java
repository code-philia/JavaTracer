...
public class GlobalFilterChecker {
    ...
    private final List<String> bootstrapIncludes = new ArrayList<>();
    private final Set<String> includes = new HashSet<>();
    private WildcardMatcher extIncludesMatcher; // className
    private WildcardMatcher extExcludesMatcher; // className

    private final List<String> includedLibraryClasses = new ArrayList<>();
    private final List<String> excludedLibraryClasses = new ArrayList<>();
    ...
    public static void setup(AppJavaClassPath appPath, String includesExpression,
        String exludesExpression) {
    ...
    public static void addFilterInfo(Trace trace) {
        if (checker instanceof GlobalFilterChecker) {
            GlobalFilterChecker filterChecker = checker;
    ...
    public void startup(AppJavaClassPath appClasspath, String includeExpression,
