...
/**
 * @author lyly For invoking, any touch on parameter's or invokeObj's fields will be recorded. (That
 * means writeField will be handle in ExecutionTracer.
 */
public class InvokingDetail {
    ...
    public boolean updateRelevantVar(Object refValue, Object fieldValue, String fieldType) {
        ...
        if (!relevant && (node.getBreakPoint().getClassCanonicalName()
            .equals(refValue.getClass().getName()))) {
            relevant = true;
        }
