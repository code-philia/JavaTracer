...
public class ClassLoaderInstrumenter extends TraceInstrumenter {
    ...
    protected boolean instrumentMethod(ClassGen classGen, ConstantPoolGen constPool,
        ...
        injectCodeTracerHitLine(insnList, constPool, tracerVar, ENTER_MARKER, insnList.getStart(),
            classNameVar,
        ...
        for (InstructionHandle returnInsnHandler : returnInsns) {
            injectCodeTracerHitLine(insnList, constPool, tracerVar, EXIT_MARKER, returnInsnHandler,
                classNameVar,
                methodSigVar, false, 0, 0, null);
        }
        ...
        injectTryCatch(methodGen, tryStart, tryEnd, constPool, tracerVar, classNameVar,
            methodSigVar);
        return true;
    }

    private void injectTryCatch(MethodGen methodGen, InstructionHandle tryStart,
        InstructionHandle tryEnd,
        ...
        LocalVariableGen exVar = methodGen.addLocalVariable("$ex", Type.THROWABLE, list.getStart(),
            list.getEnd());
