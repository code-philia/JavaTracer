...
public enum BranchCondition {
    ...
    private static final Map<Short, BranchCondition> condMap;
    private static final Map<BranchCondition, BranchCondition> negationMap;
    ...
    public static BranchCondition valueOf(short notIntCmpOpcode, short ifOpcode) {
        ...
        throw new IllegalArgumentException(String
            .format("Missing handle for the case of notIntCmpOpcode=%s, ifOpcode=%s", notIntCmpCond,
                ifOpcode));
    }
