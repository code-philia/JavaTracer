...
import org.cophi.javatracer.instrumentation.CommonParams;
...
public class CoverageAgentParams extends CommonParams {
    ...
    /**
     * There are two modes to run code coverage. BRANCH_COVERAGE: UNCIRCLE_CFG_COVERAGE:
     */
    public enum CoverageCollectionType {
        BRANCH_COVERAGE,
        UNCIRCLE_CFG_COVERAGE;

        public static CoverageCollectionType valueOf(String strValue,
            CoverageCollectionType defaultValue) {
