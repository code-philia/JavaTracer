...
public class CoverageGraphConstructor {
    ...
    private final CFGUtility cfgUtility = new CFGUtility();

    public CoverageSFlowGraph buildCoverageGraph(AppJavaClassPath appClasspath,
                ...
                case BLOCK_NODE:
                    ...
                    while (curNode != null) {
                        if ((CollectionUtils.getSize(curNode.getChildren()) > 1)
                            ...
                            || (curNode.getInstructionHandle()
                            .getInstruction() instanceof InvokeInstruction)
                            || (curNode.isBranch())
