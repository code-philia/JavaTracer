package org.cophi.javatracer.instrumentation.cfgcoverage.runtime.value;
...
import org.cophi.javatracer.utils.TypeSignatureConverter;
...
public class ValueExtractor {
    ...
    public VarValue doAppendVarValue(Object value, Variable var, VarValue parent,
        int retrieveLayer) {
        if (retrieveLayer <= 0) {
            return null;
        }
            ...
            try {
                ...
                if (value == null) {
                    ...
                    for (int i = 0; i < length; i++) {
                        ...
                        ArrayElementVar varElement = new ArrayElementVar(arrayElementID,
...
//							}
                            ...
                            if (fieldValue != null) {
                                ...
                                fieldVar.setVarID(
                                    ExecVarHelper.getFieldId(var.getVarID(), field.getName()));
                                if (isCollectionOrHashMap && HeuristicIgnoringFieldRule
                                    .isCollectionOrMapElement(var.getRuntimeType(),
                                        field.getName())) {
                                    doAppendVarValue(fieldValue, fieldVar, refVal, retrieveLayer);
                                } else {
                                    doAppendVarValue(fieldValue, fieldVar, refVal,
                                        retrieveLayer - 1);
                                }
                            }
                        } catch (Exception e) {
