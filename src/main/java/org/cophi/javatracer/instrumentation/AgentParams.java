...
import org.cophi.javatracer.instrumentation.filter.CodeRangeEntry;
...
public class AgentParams extends CommonParams {
    ...
    private final int variableLayer;
    /* format: java.lang.*;java.util.ArrayList;java.util.*\;java.util.Arrays*        */
    private final String includesExpression;
    private final String excludesExpression;
    private final int stepLimit;
    private final int expectedSteps;
    private final Set<String> overlongMethods;
    private final boolean requireMethodSplit;
    private final boolean avoidProxyToString;
    private final List<CodeRangeEntry> codeRanges;
    ...
    public static AppJavaClassPath initAppClassPath(String launchClass, String javaHome,
        List<String> classPaths, String workingDir) {
...
//		appPath.setOptionalTestMethod(entryPoint.getMethodSignature());
    ...
    public AppJavaClassPath initAppClassPath() {
        return initAppClassPath(getLaunchClass(), getJavaHome(), getClassPaths(),
            getWorkingDirectory());
    }
