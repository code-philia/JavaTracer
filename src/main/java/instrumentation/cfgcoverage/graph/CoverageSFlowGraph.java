...
/**
 * @author lyly Shortened Flow Graph for coverage recording.
 */
public class CoverageSFlowGraph implements IGraph<CoverageSFNode> {
    ...
    private final List<CoverageSFNode> exitList = new ArrayList<>();
    ...
    private final List<Integer> referenceCvgGraphIdx;
    private final int cfgSize;
    private List<CoveragePath> coveragePaths;
    private final Map<String, Branch> cachedBranches = new HashMap<>();
